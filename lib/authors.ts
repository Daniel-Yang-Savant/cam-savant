...
export const AUTHORS: Record<string, Author> = {
  '楊育愷醫師': {
    ...
    credentials: ['復健科專科醫師', '骨質疏鬆症專科醫師', '台灣增生療法醫學會會員', '台灣運動醫學醫學會會員'],
    credentialsEn: ['Board-Certified Specialist in Physical Medicine and Rehabilitation', 'Certified Osteoporosis Specialist', 'Member, Taiwan Association of Prolotherapy and Regenerative Medicine', 'Member, Taiwan Society of Sports Medicine'],
  ...
  '賴玟衛醫師': {
    ...
    locationEn: 'Changhua, Hanming, and Yuanlin Christian Hospitals',
