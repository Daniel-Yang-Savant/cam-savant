...
export const translations = {
  zh: {
    ...
    navRehabMedicine: '復健醫學',
    navFunctionalMedicine: '功能醫學',
    navWeeklyPicks: '每週論文精選',
    navFsm: 'FSM',
    ...
    consultRef: '參考文章：',
    consultPrivacyPrefix: '我已閱讀並同意',
    consultPrivacyLink: '隱私權政策',
    consultPrivacySuffix: '，了解資料將用於回覆諮詢。',
    errorContent: '請填寫您想了解的內容。',
    errorContact: '請填寫聯絡方式（電話或 Email）。',
    errorPrivacy: '請先閱讀並同意隱私權政策。',
  ...
  en: {
    ...
    navRehabMedicine: 'Rehab Medicine',
    navFunctionalMedicine: 'Functional Medicine',
    navWeeklyPicks: 'Weekly Picks',
    navFsm: 'FSM',
    ...
    consultPrivacyPrefix: 'I have read and agree to the ',
    consultPrivacyLink: 'Privacy Policy',
    consultPrivacySuffix: ' and understand how my information will be used.',
    errorContent: 'Please describe your question.',
    errorContact: 'Please provide your contact information.',
    errorPrivacy: 'Please read and accept the Privacy Policy.',
    errorNetwork:
