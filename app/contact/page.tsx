...
const clinics = [
  {
    ...
    bookingUrl: 'https://www.cch.org.tw/OPD/appointment.aspx',
    phone: '(04) 723-8595',
  ...
  },
  {
    ...
    bookingUrl: 'https://www.ntch.org.tw/',
    phone: '(049) 222-2595',
    scheduleNote: '門診時間請至醫院官網查詢或來電確認',
    color: 'green',
  },
  {
    ...
    bookingUrl: 'https://www.erhlin.cch.org.tw/',
    phone: '(04) 896-3111',
    scheduleNote: '門診時間請至醫院官網查詢或來電確認',
    color: 'amber',
  },
          ...
          return (
            <div key={clinic.hospital} className={`rounded-2xl border ${c.border} bg-white dark:bg-neutral-900 p-6 flex flex-col gap-4`}>
              ...
              <div>
                ...
                <p className="text-xs text-neutral-400 dark:text-neutral-500 mt-0.5">{clinic.hospitalEn}</p>
              </div>
              ...
              <ul className="space-y-2 text-sm text-neutral-600 dark:text-neutral-300">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-neutral-400 dark:text-neutral-500 text-xs">{clinic.scheduleNote}</span>
                </li>
              </ul>
