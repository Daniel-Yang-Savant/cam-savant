...
export const metadata: Metadata = {
  ...
  alternates: bilingualAlternates('/perioperative-rehab'),
...
const categories: Category[] = [
  {
    ...
    conditions: [
      ...
      {
        slug: 'breast-cancer-rehab',
        name: '乳癌手術復健',
        nameEn: 'Breast Cancer Surgery Rehab',
        summary: '肩關節活動度、淋巴水腫預防與體能恢復',
      },
      {
        slug: 'gynecologic-cancer-rehab',
        name: '婦癌手術復健',
        nameEn: 'Gynecologic Cancer Surgery Rehab',
        summary: '下肢淋巴水腫、骨盆底功能與癌因性疲憊管理',
      },
      {
        slug: 'prostate-cancer-rehab',
        name: '攝護腺癌手術復健',
        nameEn: 'Prostate Cancer Surgery Rehab',
        summary: '尿失禁改善、骨盆底肌訓練與體能恢復',
      },
    ],
  },
  {
    ...
    conditions: [
      ...
      {
        slug: 'hip-fracture-rehab',
        name: '髖部骨折術後復健',
        nameEn: 'Hip Fracture Surgery Rehab',
        summary: '早期下床、肌力訓練與跌倒預防',
      },
      {
        slug: 'ankle-fracture-rehab',
        name: '踝關節骨折術後復健',
        nameEn: 'Ankle Fracture Surgery Rehab',
        summary: '負重時程、上下樓梯與恢復步態',
      },
      {
        slug: 'distal-radius-fracture-rehab',
        name: '遠端橈骨骨折術後復健',
        nameEn: 'Distal Radius Fracture Rehab',
        summary: '手腕活動、握力訓練與日常功能恢復',
      },
      {
        slug: 'achilles-repair-rehab',
        name: '阿基里斯腱修補術後復健',
        nameEn: 'Achilles Tendon Repair Rehab',
        summary: '負重時程、踝關節活動與跑步回場',
      },
      {
        slug: 'lumbar-discectomy-rehab',
        name: '椎間盤手術後復健',
        nameEn: 'Lumbar Discectomy Rehab',
        summary: '坐骨神經痛改善後的活動與工作回復時程',
      },
      {
        slug: 'lumbar-fusion-rehab',
        name: '腰椎融合術後復健',
        nameEn: 'Lumbar Fusion Rehab',
        summary: '走路、護腰使用與核心訓練完整計畫',
      },
    ],
  },
  {
    ...
    conditions: [
      ...
      },
      {
        ...
        name: '瓣膜手術／TAVI／TAVR 術後復健',
        nameEn: 'Valve Surgery & TAVI/TAVR Rehab',
        summary: '高齡患者體力恢復、跌倒預防與運動安全',
      },
    ],
  },
]
    ...
    <div className="min-h-screen bg-[#f5f0e8]">
      ...
      <section className="bg-neutral-950 text-white mt-4">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 text-center">
          ...
          <p className="mt-5 max-w-2xl mx-auto text-base md:text-lg text-neutral-500 leading-relaxed">
            從手術前體能預備到術後各階段功能恢復，
              ...
              {cat.conditions.map((cond) => (
                ...
                >
                  <div className="flex-1">
                    ...
                    <p className="mt-1 text-xs text-neutral-500 tracking-widest uppercase">
                      {cond.nameEn}
                    </p>
                  ...
                  {cond.coming ? (
                    ...
                    <div className="mt-5 inline-flex items-center justify-center w-full rounded-xl bg-neutral-100 text-neutral-500 text-xs font-medium tracking-wide py-2.5 cursor-default select-none">
                      內容籌備中
                    </div>
                  ) : (
                    <Link
