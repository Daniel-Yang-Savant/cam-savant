      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-12">
          ...
          <h1
            ...
            className="mt-3 text-2xl md:text-3xl font-semibold tracking-tight text-neutral-950 dark:text-neutral-100"
          >
            CAM Savant
          </h1>
          <p className="mt-3 max-w-3xl text-base leading-8 text-neutral-600 dark:text-neutral-400">
