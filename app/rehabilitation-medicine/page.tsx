...
export default function RehabMedicinePage() {
  const posts = getPostsByCategory('rehabilitation-medicine')
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 md:py-20">
      ...
      <PostList posts={posts} activeCategory="rehabilitation-medicine" />
    </div>
  )
}
